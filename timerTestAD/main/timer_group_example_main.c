...
#define TIMER_INTERVAL1_SEC   (3)   // sample test interval for the second timer
...
static void example_tg0_timer_init(int timer_idx, bool auto_reload, double timer_interval_sec)
{
    ...
    timer_set_counter_value(TIMER_GROUP_0, timer_idx, 0x00000000000); //UUL
...
void app_main()
{
    ...
    example_tg0_timer_init(TIMER_0, TEST_WITHOUT_RELOAD,    TIMER_INTERVAL1_SEC); //TEST_WITH_RELOAD
